...
%{
This is another contructor with return values
function [hpfSignal, highGammaSignal, lowGammaSignal, ...
          alphaSignal, betaSignal, thetaSignal, ...
          deltaSignal, infraSlowSignal] ...
    = applyFilters(rawSignal, lfp, ...
    	  hpfSignalPath, highGammaSignalPath, lowGammaSignalPath, ...
          alphaSignalPath, betaSignalPath, thetaSignalPath, ...
          deltaSignalPath, infraSlowSignalPath)
%}
